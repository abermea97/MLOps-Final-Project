...
import pandas as pd
path = '/dbfs/FileStore/tables/diabetes_r.csv'
...
summary = automl.classify(train_df, target_col="Diabetes_binary", timeout_minutes=30)
...
test_df["Diabetes_binary_predicted"] = predictions
display(test_df)
...
display(test_df_s.withColumn("Diabetes_binary_predicted", predict_udf()))
...
# Prepare the dataset
y_pred = test_df["Diabetes_binary_predicted"]
